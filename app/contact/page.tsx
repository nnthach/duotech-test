          ...
          <div className="mx-auto max-w-7xl">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl text-white/60">
                Have a question or ready to start your fitness journey? Reach
                ...
                <div className="space-y-8">
                  {CONTACT_INFO.map((item) => {
                    ...
                    return (
                      <div
                        key={item.title}
                        className="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/5 p-5 transition hover:border-red-600/40"
                      >
